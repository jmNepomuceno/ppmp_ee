                ...
                try {
                    ...
                    for (let i = 0; i < response.length; i++) {
                        ...
                        dataSet.push([
                            ...
                            `${sectionList}`, // ✅ Display section data as a list
                    ...
                    $('#cart-table').DataTable({
                        data: dataSet,
                        columns: [
                            { title: "PPMP 2025", data: 0 },
                            { title: "END USER", data: 1 },
                            { title: "TOTAL QUANTITY", data: 2 },
                        ],
                        columnDefs: [
                            { targets: 0, createdCell: function(td) { $(td).addClass('item-ppmp-td'); } },
                            { targets: 1, createdCell: function(td) { $(td).addClass('item-end_user-td'); } },
                            { targets: 2, createdCell: function(td) { $(td).addClass('item-total_quantity-td'); } },
                        ],
                        "paging": false,
                        "info": false,
                        "ordering": false,
